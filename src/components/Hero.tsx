  ...
  return (
    <section className="hero" style={{ padding: 0 }}>
      <div className="hero-text">
        <p className="hero-eyebrow">Board-Certified Psychiatrist · Lahore, Pakistan</p>
        <h1>
          Heal your<br />
          <em>mind.</em><br />
          Reclaim your life.
        ...
        <p className="hero-subtitle">
          Dr. Saba Asad offers compassionate, evidence-based psychiatric care for anxiety, depression, trauma, and
          all aspects of mental wellbeing — in-person and online across Pakistan.
        </p>
        <div className="hero-badges">
          <span className="badge">🎓 MBBS · FCPS Psychiatry</span>
