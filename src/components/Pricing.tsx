      ...
      <section id="pricing" className="pricing-section">
        ...
        <div className="pricing-grid">
          ...
          <div className="pricing-card featured">
            ...
            <p className="pricing-plan">Regular Session</p>
            <div className="pricing-amount"><sup>PKR</sup> 2,500</div>
            <p className="pricing-period">Per session · 45 minutes</p>
            <hr className="pricing-divider" />
            <ul className="pricing-features">
              <li>Standard therapy &amp; counselling</li>
              <li>In-person (Lahore / Gujranwala) or online</li>
              <li>Progress review &amp; skill building</li>
              <li>Flexible weekly or fortnightly scheduling</li>
            </ul>
            <a href="#contact" className="btn-price">Book Now</a>
          </div>
          <div className="pricing-card">
